...
(1, 'slider-1.jpg', 'Welcome to Lavish Look', 'Shop Online for Latest Women Accessories', 'View Women Accessories', 'product-category.php?id=4&type=mid-category', 'Center'),
(2, 'slider-2.jpg', '50% Discount on All Products', 'Trendy Collections', 'Read More', '#', 'Center'),
(3, 'slider-3.jpg', '24 Hours Customer Support', 'The Best Product in the World is Worthless Without a Buyer.', 'Read More', '#', 'Right');
